...
class AddTestimonial(
    ...
    success_message = "Your testimonial has been successfully added"
...
class EditTestimonial(
    ...
    success_message = "Testimonial successfully edited"

    def test_func(self):
        """
        Prevent another user from editing user's testimonial
        """
...
class DeleteTestimonial(
    ...
    def test_func(self):
        """
        Prevent another user from deleting another user's testimonials
        """
        testimonial = self.get_object()
        return testimonial.name == self.request.user\
            or self.request.user.is_superuser
